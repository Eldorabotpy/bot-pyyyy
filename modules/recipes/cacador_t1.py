...
RECIPES: Dict[str, Dict[str, Any]] = {
    ...
    "work_arco_batedor_cacador": {
        ...
        "xp_gain": 28,
        "inputs": {"madeira": 10, "linho": 5, "nucleo_de_forja": 1},
    ...
    "work_capuz_batedor_cacador": {
        ...
        "xp_gain": 20,
        "inputs": {"couro_curtido": 6, "pano_simples": 3, "nucleo_de_forja": 1},
    ...
    "work_peitoral_batedor_cacador": {
        ...
        "xp_gain": 35,
        "inputs": {"couro_curtido": 10, "pano_simples": 4, "nucleo_de_forja": 1},
    ...
    "work_calcas_batedor_cacador": {
        ...
        "xp_gain": 30,
        "inputs": {"couro_curtido": 8, "pano_simples": 5, "nucleo_de_forja": 1},
    ...
    "work_botas_batedor_cacador": {
        ...
        "xp_gain": 15,
        "inputs": {"couro_curtido": 5, "pano_simples": 2, "nucleo_de_forja": 1},
    ...
    "work_anel_batedor_cacador": {
        ...
        "xp_gain": 40,
        "inputs": {"couro_curtido": 2, "pena": 5, "nucleo_de_forja": 1},
    ...
    "work_colar_batedor_cacador": {
        ...
        "xp_gain": 50,
        "inputs": {"couro_curtido": 3, "pena": 8, "dente_afiado": 1, "nucleo_de_forja": 1},
    ...
    "work_brinco_batedor_cacador": {
        ...
        "time_seconds": 300,  # 5 minutos
        "xp_gain": 35,
        "inputs": {"couro_curtido": 1, "pena": 10, "nucleo_de_forja": 1},
