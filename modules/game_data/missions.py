...
MISSION_CATALOG = [
    ...
    # --- Missões Globais (Qualquer lugar) ---
    {
    ...
    # --- Missões de Calabouço (Todos podem entrar) ---
    {
        "id": "dungeon_quarry_normal",
        "title": "Coração de Pedra",
        "description": "Complete o Calabouço da Pedreira na dificuldade Normal.",
    ...
    # --- Missões Passivas e PvP (Universais) ---
    {
        "id": "spend_energy_50",
