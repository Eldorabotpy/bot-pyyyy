...
# ============================================================
# ⚔️ SINCRONIZAR STATUS OPERACIONAL DAS GUERRAS
# ============================================================
...
def sincronizar_status_guerras_semana(
    ...
    """
    Mantém o documento real da Guerra alinhado
    às fases operacionais do calendário.

    IMPORTANTE:
    - AGENDADA pode ser aplicada automaticamente.
    - EM_ANDAMENTO pode ser aplicada automaticamente.
    - FINALIZADA NÃO é aplicada aqui, pois a guerra
      precisa possuir resultado antes de ser encerrada.
    """
    ...
    # Mantém também os documentos de inscrição
    # coerentes com a fase da guerra.
